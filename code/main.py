...
#sklearn.metrics module is used for accuracy(mean squared error) score
...
d = Dataset()
d.load_users("../data/u.user", user)  #user is a list of objects of User class
d.load_items("../data/u.item", item) #item is a list of objects of Item class
d.load_ratings("../data/u.base", rating) #rating is a list of objects of Rating class
d.load_ratings("../data/u.test", rating_test) #rating_test is to be used for testing purpose
